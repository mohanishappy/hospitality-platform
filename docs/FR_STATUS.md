...
| FR-Z5 | Platform Portal enterprise bootstrap | **9E shipped** — `/platform`, `POST /platform/enterprises`, bootstrap invite |
...
**Phase 10:** see [`PHASE10_PLAN.md`](PHASE10_PLAN.md). **10A–10F** shipped. OpenAPI admin catalog schemas remain optional polish.

**Phase 9 (remaining):** **9C** email delivery (deferred). **9E** + **9G** shipped (Platform Portal, enterprise suspend, gateway zero-brand fix).
